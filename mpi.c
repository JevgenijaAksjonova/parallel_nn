...
void test(const char filename[], const char labels_filename[], double *param, int *layerSize, int Nlayers, int p, int P) {
...
/* local variables */
    ...
    const char filename_test[] = "/Users/nyuad/Documents/workspaceC++/parallel/parallel_nn/mnist_data/test_images.csv";
...
/* Read batch size from command line */
    ...
    test(filename_test, filename_test_labels, param, layerSize, Nlayers, p, P);
